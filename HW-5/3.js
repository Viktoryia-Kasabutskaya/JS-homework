// Create a function that takes a Roman numeral as its argument and returns its value as a numeric demical integer. You don't
// need to validate the form of the Roman numeral.

const convertRomanianNumbers = (romanianNumber) => {
